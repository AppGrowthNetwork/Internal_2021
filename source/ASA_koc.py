...
access_token = "eyJhbGciOiJkaXIiLCJlbmMiOiJBMjU2R0NNIiwia2lkIjpudWxsfQ..9V11VD_EN7SHXpZ5.-Zjt5Ef8lIVYxR4M_FrZ3Rx_wJrB9-KFF0YIDtTxnKaXbAqweKwbJX58GGwST_dc52kM_ZC1k6rnqNv8GDfe6NjU47hjHQ_WKavYoou-E5o7pUh47A8SvmaH7kMrDA0RWEgzyQnbLWDjI1ED6yNIXc0IIKgEMzqJq4WFIQkaEXjJCdmxjQU5f_JFg3r3XkfvaBQEqHmVt0FCu7YjEGoEdOu5jTehOiSHFM4ibAJIN_YaLH50Qzfv8w46kQjZaAoLBm8hlGqtT4HnG_HXYDJ2XuQ.OATIirM6j8NTM7-pd6A8TA"
...
ORG_ID = "2297600" # Your ORG_ID, you can find in Apple Search ads, cabinet in the top right menu
...
def main(START_CURRENT, END_CURRENT, START, END):
    ...
    with open('dash_asa_daily_koc.html', 'w') as f:
        for fig in figs_asa:
